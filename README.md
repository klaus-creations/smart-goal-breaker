...
The project is structured as a Monorepo containing `backend` and `frontend` directories.

### **Backend Structure**

Designed for scalability using "Dependency Injection" and "Separation of Concerns".

```text
backend/app/
├── api/          # Route Controllers (Handles HTTP requests)
├── services/     # Business Logic (AI integration lives here)
